...
LOG_FILE="/home/brainspiller/Documents/hunt/logs/url_paramjs.log"
...
while IFS= read -r line; do
    ...
    run_tool "$domain" "$program" "URLCollection" "url-collection"
    run_tool "$domain" "$program" "ParameterJSExtraction" "param-js-extraction"
done < "$CONFIG_FILE"
